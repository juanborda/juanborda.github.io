...
var app = new Vue({
  el: '#app',
  computed: {
    email: () => 'borda.jpablo' + '@' + ['g','m','a','i','l'].join('') + '.com'
  },
  data: {    
    jobs: [
      {
        ...
        company: 'Datto',        
        tech: 'LAMP Stack, VueJS, Gridsome, CraftCMS, HTML5/CSS3',
        projects: 'Datto.com - Backupify.com'
      },
      {
        year: '2016 - 2019',
        title: 'Senior Web Developer',
      ...
      },
      {
        ...
        projects: 'uFoodz, MyWurld, LaIndustria.pe, PrivacyRights.org, OriginDigital NextGenerationPlayer'
      },
    ],
    skills: [
      'HTML5', 'CSS3', 'PHP', 'JavaScript',
      'Laravel', 'Nodejs', 'AngularJS 1.x', 'Vuejs', 'NextJS',
      'Bootstrap', 'TailwindCSS', 'Bulma', 'Vuetify',      
      'WordPress', 'Drupal 6', 'CraftCMS 3',
      'GoogleMapsApi', 'Facebook Api', 'Twitter API',
      'MySQL', 'MongoDB', 'MsSqL'
    ],
    edu: [
      {
